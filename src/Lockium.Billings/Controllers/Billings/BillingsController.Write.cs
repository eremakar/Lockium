...
{
    public partial class BillingsController
    {
        /// <summary>
        /// Add new billing
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] BillingDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] BillingDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<BillingDto> patch)
        {
