...
namespace Lockium.Devices.Controllers.Devices
{
    public partial class ChannelsController
    {
        ...
        public override async Task<object> AddAsync([FromBody] ChannelDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] ChannelDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<ChannelDto> patch)
        {
